<template>
  <div
    class="cyber-card group relative overflow-hidden transition-all duration-300"
    :class="[
  ...
  >
        ...
        <slot name="header">
          <div class="flex items-center gap-12">
            ...
            <div class="flex items-center gap-8">
              <div class="w-4 h-12" :class="variant === 'danger' ? 'bg-cyber-red' : 'bg-cyber-yellow'"></div>
              <h3
    ...
    <!-- 故障效果层 -->
    <div v-if="glitchActive" class="glitch-layers pointer-events-none">
